...
public class EventoControllers {
	...
	@GetMapping("/fechaAnteriorHoy")
	public ResponseEntity<?> findByFechaAnterior(){
		return ResponseEntity.ok(this.eventoService.findByFechaAnterior());
	}
	
	
	//Obtener eventos cuya fecha sea futura a hoy
	@GetMapping("/fechaPosteriorHoy")
	public ResponseEntity<?> findByFechaPosterior(){
		return ResponseEntity.ok(this.eventoService.findByFechaPosterior());
	}
